    ...
    <section className="flex items-center justify-center h-screen sm:p-16 bg-gray-900 dark:text-gray-100">
      <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-fit text-white">
        ...
        <div className="text-3xl flex flex-col gap-2">
          ...
          <p>We are probably working on that has blown up!</p>
        </div>
        <Link
          rel="noopener noreferrer"
          to={"/"}
          className="px-8 py-3 font-bold rounded border border-transparent dark:bg-violet-400 dark:text-gray-900 hover:border-white"
        >
          Back to homepage
        </Link>
      </div>
